...
# mydata8 = combine_similar_sessions(mydata7)
export_cat8(mydata7)

# mydata12, courses_table, instructors_table = encode_courses_and_instructors(mydata11)

# mydata12.repartition(1).write.format("csv").option("header", "true").save('clean-data')
# courses_table.repartition(1).write.format("csv").option("header", "true").save('clean-courses')
# instructors_table.repartition(1).write.format("csv").option("header", "true").save('clean-instructors')
